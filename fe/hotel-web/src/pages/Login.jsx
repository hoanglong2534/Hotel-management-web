  ...
  return (
    <>
      ...
      <div className='md:!px-50 lg:!px-100 sm:!px-30 !px-10 relative !py-30 z-20'>
        <Tabs defaultActiveKey="1" centered items={items} onChange={onChange} className='bg-white min-h-[450px] shadow w-full lg:!px-20 !px-10  rounded-[10px] sm:!px-6 md:!px-10 ' />
      </div>
    </>
  )
}
